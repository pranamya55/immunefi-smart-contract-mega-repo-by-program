...
contract TestGsmFixedPriceStrategy is TestGhoBase {
  ...
  function testOneToOnePriceRatio() public {
    FixedPriceStrategy strategy = new FixedPriceStrategy(1e18, address(USDX_TOKEN), 6);
  ...
  function testOneToTwoPriceRatio() public {
    FixedPriceStrategy strategy = new FixedPriceStrategy(2e18, address(USDX_TOKEN), 6);
    uint256 usdxIn = 100e6;
  ...
  function testTwoToOnePriceRatio() public {
    FixedPriceStrategy strategy = new FixedPriceStrategy(0.5e18, address(USDX_TOKEN), 6);
    uint256 usdxIn = 100e6;
  ...
  function testRevertZeroPriceRatio() public {
    ...
    new FixedPriceStrategy(0, address(USDX_TOKEN), 6);
  }
