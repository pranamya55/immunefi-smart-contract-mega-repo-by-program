...
contract TestGsm4626 is TestGhoBase {
  ...
  function testRevertConstructorInvalidPriceStrategy() public {
    ...
    new Gsm4626(address(GHO_TOKEN), address(USDX_4626_TOKEN), address(newPriceStrategy));
  }

  function testRevertConstructorZeroAddressParams() public {
    vm.expectRevert('ZERO_ADDRESS_NOT_VALID');
    new Gsm4626(address(0), address(USDX_4626_TOKEN), address(GHO_GSM_4626_FIXED_PRICE_STRATEGY));
  ...
  function testSellAssetZeroFee() public {
    ...
    assertEq(USDX_4626_TOKEN.balanceOf(ALICE), 0, 'Unexpected final USDX balance');
  ...
  function testRevertSellAssetTooMuchUnderlyingExposure() public {
    ...
    vm.startPrank(ALICE);
    USDX_4626_TOKEN.approve(address(gsm), DEFAULT_GSM_USDX_EXPOSURE);
  ...
  function testGetGhoAmountForSellAsset() public {
    ...
    assertEq(
      DEFAULT_GSM_USDX_AMOUNT - USDX_4626_TOKEN.balanceOf(ALICE),
      exactAssetAmount,
  ...
  function testBuyAssetSendToOther() public {
    ...
    assertEq(ghoSold, DEFAULT_GSM_GHO_AMOUNT + buyFee, 'Unexpected GHO amount sold');
    assertEq(assetAmount, DEFAULT_GSM_USDX_AMOUNT, 'Unexpected asset amount bought');
    assertEq(USDX_4626_TOKEN.balanceOf(BOB), 0, 'Unexpected final USDX balance');
    assertEq(
      USDX_4626_TOKEN.balanceOf(CHARLES),
      DEFAULT_GSM_USDX_AMOUNT,
      'Unexpected final USDX balance'
    );
    assertEq(GHO_TOKEN.balanceOf(ALICE), ghoOut, 'Unexpected final GHO balance');
  ...
  function testBuyThenSellAtMaximumBucketCapacity() public {
    ...
    assertEq(USDX_4626_TOKEN.balanceOf(ALICE), 1e6, 'Unexpected Alice USDX balance after buy');
    ...
    assertEq(
      ...
      0,
      'Unexpected Alice USDX balance after second sell'
    );
    assertEq(
      GHO_GSM_4626.getExposureCap(),
      DEFAULT_GSM_USDX_EXPOSURE,
  ...
  function testRescueUnderlyingTokens() public {
    ...
    _mintVaultAssets(USDX_4626_TOKEN, USDX_TOKEN, address(GHO_GSM_4626), DEFAULT_GSM_USDX_AMOUNT);
  ...
  function testRevertRescueUnderlyingTokens() public {
    ...
    GHO_GSM_4626.rescueTokens(address(USDX_4626_TOKEN), ALICE, 1);
  }
  ...
  function testSeize() public {
    ...
    assertEq(
      USDX_4626_TOKEN.balanceOf(TREASURY),
      DEFAULT_GSM_USDX_AMOUNT,
  ...
  function testInjectUnderlying() public {
    ...
    _mintVaultAssets(USDX_4626_TOKEN, USDX_TOKEN, BOB, DEFAULT_GSM_USDX_AMOUNT);
  ...
  function testInjectUnderlyingMoreThanNeeded() public {
    ...
    _mintVaultAssets(USDX_4626_TOKEN, USDX_TOKEN, BOB, DEFAULT_GSM_USDX_AMOUNT + 1);
