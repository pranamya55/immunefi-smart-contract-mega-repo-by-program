...
gas-report :; forge test --mp 'test/gas/**' --isolate

# Coverage
coverage-base :; forge coverage --fuzz-runs 50 --report lcov --no-match-coverage "(script|test|deployments|mocks|dependencies)"
