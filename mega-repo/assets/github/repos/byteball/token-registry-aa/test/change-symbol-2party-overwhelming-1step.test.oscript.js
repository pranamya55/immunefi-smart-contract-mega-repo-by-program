...
describe("Change asset's symbol to a new one with overwhelming support in 1 step", function () {
	...
	it('Bob offers another name for the asset with overwhelming support', async () => {
		const symbol = 'BOBS'
		const amount = 0.6e9
