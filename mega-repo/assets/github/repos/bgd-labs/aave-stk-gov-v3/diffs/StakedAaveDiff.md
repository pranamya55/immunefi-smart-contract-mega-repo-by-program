...
-
 ...
 /**
@@ -124,835 +122,1496 @@ interface IERC20Metadata is IERC20 {
...
@@ -1419,6 +2078,492 @@ interface IStakedTokenV2 {
   ) external;
 }
...
+
  ...
  *
@@ -1712,32 +2857,272 @@ contract AaveDistributionManager {
   }
 }
...
@@ -4058,13 +5390,76 @@ contract StakedTokenV3 is
...
@@ -4087,26 +5482,8 @@ interface IGhoVariableDebtTokenTransferHook {
 }
...
@@ -4136,36 +5513,6 @@ interface IStakedAaveV3 is IStakedTokenV3 {
     address to,
     uint256 amount
...
-  ) external;
 ...
 /**
@@ -4176,15 +5523,13 @@ interface IERC20WithPermit is IERC20 {
...
+    return 6;
   ...
   constructor(
@@ -4211,24 +5556,7 @@ contract StakedAaveV3 is StakedTokenV3, IStakedAaveV3 {
   /**
    * @dev Called by the proxy contract
    */
-  function initialize(
