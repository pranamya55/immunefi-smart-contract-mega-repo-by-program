```diff
diff --git a/./flattened/avalanche.sol b/./flattened/NewCollector.sol
index 10f63b3..7f0b780 100644
--- a/./flattened/avalanche.sol
...
@@ -233,13 +824,38 @@ contract Collector is VersionedInitializable, ICollector {
   }
...
+
   ...
   function getRevision() internal pure override returns (uint256) {
     return REVISION;
@@ -251,23 +867,109 @@ contract Collector is VersionedInitializable, ICollector {
   }
...
@@ -281,4 +983,125 @@ contract Collector is VersionedInitializable, ICollector {
     _fundsAdmin = admin;
