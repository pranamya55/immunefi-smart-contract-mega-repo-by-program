```diff
diff --git a/./flattened/mainnet.sol b/./flattened/NewCollector.sol
index 2df2421..7f0b780 100644
--- a/./flattened/mainnet.sol
+++ b/./flattened/NewCollector.sol
@@ -1,460 +1,394 @@
...
+  }
 ...
 /**
@@ -474,10 +408,7 @@ library SafeERC20 {
         address to,
         uint256 value
     ) internal {
-        _callOptionalReturn(
...
@@ -486,10 +417,7 @@ library SafeERC20 {
         address to,
         uint256 value
     ) internal {
-        _callOptionalReturn(
...
+        _callOptionalReturn(token, abi.encodeWithSelector(token.transferFrom.selector, from, to, value));
     ...
     /**
@@ -511,10 +439,7 @@ library SafeERC20 {
...
@@ -523,14 +448,7 @@ library SafeERC20 {
         uint256 value
     ) internal {
...
@@ -540,22 +458,28 @@ library SafeERC20 {
     ) internal {
         unchecked {
...
@@ -567,23 +491,226 @@ library SafeERC20 {
...
-
  ...
  *
@@ -601,123 +728,52 @@ library SafeERC20 {
...
+ * or transfer dynamics or streaming capabilities.
  ...
  * Modifications:
@@ -727,313 +783,325 @@ abstract contract AdminControlledEcosystemReserve is
