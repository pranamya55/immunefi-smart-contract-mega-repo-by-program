...
library Checkpoints {
    ...
    /**
     * @dev Returns the value in the last (most recent) checkpoint with a key lower or equal than the search key, or 
    ...
    /**
     * @dev Returns whether there is a checkpoint with a key lower or equal than the search key in the structure 
     * (i.e. it is not empty), and if so the key and value in the checkpoint, and its position in the trace.
     */
    ...
    /**
     * @dev Returns the value in the last (most recent) checkpoint with a key lower or equal than the search key, 
    ...
    /**
     * @dev Return the index of the last (most recent) checkpoint with a key lower or equal than the search key, or 
    ...
    /**
     * @dev Access an element of the array without performing a bounds check. The position is assumed to be within 
     * bounds.
     */
