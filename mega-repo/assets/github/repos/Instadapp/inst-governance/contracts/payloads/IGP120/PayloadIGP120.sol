...
/// @notice IGP120: Set DexT1DeploymentLogic on DexFactory to 0x3FB3FE857C1eE52e7002196E295a7ADfFeD80819
contract PayloadIGP120 is PayloadIGPMain {
    uint256 public constant PROPOSAL_ID = 120;

    /// @dev Dex T1 Deployment Logic contract (0x3FB3FE857C1eE52e7002196E295a7ADfFeD80819)
    address public constant DEX_T1_DEPLOYMENT_LOGIC =
        0x3FB3FE857C1eE52e7002196E295a7ADfFeD80819;

    function execute() public virtual override {
        super.execute();

        // Action 1: Set Dex T1 deployment logic on DexFactory via setDexDeploymentLogic
        action1();
    }
    ...
    /// @notice Action 1: Set Dex T1 deployment logic on DexFactory
    function action1() internal isActionSkippable(1) {
        DEX_FACTORY.setDexDeploymentLogic(DEX_T1_DEPLOYMENT_LOGIC, true);
    }
}
