...
export const abiTermMaxRouterV1Plus = [
  {
    type: 'function',
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        name: 'swapData',
        type: 'tuple',
        internalType: 'struct ITermMaxRouterV1Plus.TermMaxSwapData',
        components: [
          {
            name: 'tokenIn',
            type: 'address',
  ...
  {
    type: 'error',
    name: 'CallbackAddressNotMatch',
    inputs: [],
  },
  {
    type: 'error',
    name: 'CallbackReentrant',
    inputs: [],
  },
  {
    type: 'error',
