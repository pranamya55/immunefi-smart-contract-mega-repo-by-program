...
contract DeployPriceFeedFactoryV1 is DeployBase {
    ...
    function deployPriceFeedFactory() internal returns (PriceFeedFactory) {
        console.log("Deploying PriceFeedFactory...");
        PriceFeedFactory factory = new PriceFeedFactory();
        console.log("PriceFeedFactory deployed at:", address(factory));
        return factory;
    }
    ...
    function run() public {
        ...
        // deploy PriceFeedFactory
        priceFeedFactory = deployPriceFeedFactory();
        vm.stopBroadcast();
        ...
        console.log("===== PriceFeedFactory Info =====");
        console.log("Deployer:", deployerAddr);
        ...
        // Write the JSON file
        string memory filePath = string.concat(deploymentsDir, "/", network, "-price-feed-factory-v1.json");
