...
pub const DEPOSIT_STAKE_DISCRIMINATOR: u8 = 2;
...
impl DepositStake {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = DepositStakeInstructionData::new().try_to_vec().unwrap();
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct DepositStakeInstructionArgs {
    pub owner: Pubkey,
}

impl DepositStakeInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
impl DepositStakeBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = DepositStakeInstructionArgs {
...
pub struct DepositStakeCpi<'a, 'b> {
    ...
    pub __args: DepositStakeInstructionArgs,
}
