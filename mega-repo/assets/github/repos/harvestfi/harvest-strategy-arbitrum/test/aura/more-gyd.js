...
const Strategy = artifacts.require("AuraStrategyMainnet_MORE_GYD");

// Developed and tested at blockNumber 266399850
...
describe("Arbitrum Mainnet Aura Gyro MORE-GYD", function() {
  ...
  let more = "0x25ea98ac87A38142561eA70143fd44c4772A16b6";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x4284c68f567903537E2d9Ff726fdF8591E431DDC");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "balancerPool": [
        ...
        [gyd, more, "0x4284c68f567903537e2d9ff726fdf8591e431ddc0002000000000000000005b5"],
      ]
    });
