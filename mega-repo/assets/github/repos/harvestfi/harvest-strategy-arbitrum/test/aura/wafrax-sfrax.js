...
const Strategy = artifacts.require("AuraStrategyMainnet_waFRAX_sFRAX");

// Developed and tested at blockNumber 266375680

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Aura Gyro MORE-GYD", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xDcc5b9BA5aB98DC38477831Ff359d81f911423eb";
  let weth = "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1";
  let wsteth = "0x5979d7b546e38e414f7e9822514be443a4800529";
  let sfrax = "0xe3b3FE7bcA19cA77Ad877A5Bebab186bEcfAD906";
  let wafrax = "0x89AEc2023f89E26Dbb7eaa7a98fe3996f9d112A8";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x36C2f879f446c3b6533f9703745C0504f3a84885");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"balancer": [weth, wsteth, sfrax]},
        {"balancer": [sfrax, wafrax]},
      ],
      "balancerPool": [
        [weth, wsteth, "0x7967fa58b9501600d96bd843173b9334983ee6e600020000000000000000056e"],
        [wsteth, sfrax, "0xc757f12694f550d0985ad6e1019c4db4a803f1600002000000000000000004de"],
        [sfrax, wafrax, "0x36c2f879f446c3b6533f9703745c0504f3a84885000200000000000000000591"],
      ]
    });
