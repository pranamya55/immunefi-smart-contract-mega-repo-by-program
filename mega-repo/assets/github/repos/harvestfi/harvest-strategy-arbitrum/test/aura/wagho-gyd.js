...
const Strategy = artifacts.require("AuraStrategyMainnet_waGHO_GYD");

// Developed and tested at blockNumber 266401100

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Aura Gyro waGHO-GYD", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xcCb8E090Fe070945cC0131a075B6e1EA8F208812";
  let weth = "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1";
  let wsteth = "0x5979d7b546e38e414f7e9822514be443a4800529";
  let gyd = "0xCA5d8F8a8d49439357d3CF46Ca2e720702F132b8";
  let wagho = "0xD9FBA68D89178e3538e708939332c79efC540179";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xff38cC0cE0DE4476C5a3e78675b48420A851035B");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "balancerPool": [
        ...
        [gyd, wagho, "0xff38cc0ce0de4476c5a3e78675b48420a851035b000200000000000000000593"],
      ]
    });
