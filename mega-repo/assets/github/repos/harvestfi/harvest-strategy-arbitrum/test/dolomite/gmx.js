...
const Strategy = artifacts.require("DolomiteLendStrategyMainnet_GMX");

// Developed and tested at blockNumber 260274200

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Dolomite Lend GMX", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x628d6380a28b8d9aE7516597Fa625934185bfeD4";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xfc5A1A6EB076a2C7aD06eD22C90d7E710E35ad0a");
