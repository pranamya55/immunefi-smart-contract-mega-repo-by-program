...
const Strategy = artifacts.require("MorphoVaultStrategyMainnet_HY_USDC");

// Developed and tested at blockNumber 385250800

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Arbitrum Mainnet Morpho Vault HY USDC", function() {
  let accounts;
  ...
  before(async function() {
    ...
    await impersonates([governance, underlyingWhale, arbWhale, morphoWhale]);
