...
const Strategy = artifacts.require("BalancerStrategyV3Mainnet_wstETH_amWETH");

// Developed and tested at blockNumber 43206470

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Polygon Mainnet Balancer wstETH-amWETH", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x4a77eF015ddcd972fd9BA2C7D5D658689D090f1A");
