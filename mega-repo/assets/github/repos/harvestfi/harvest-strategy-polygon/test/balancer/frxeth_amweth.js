...
const Strategy = artifacts.require("BalancerStrategyV3Mainnet_frxETH_amWETH");

// Developed and tested at blockNumber 43206470

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Polygon Mainnet Balancer frxETH-amWETH", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xD00f9Ca46ce0E4A63067c4657986f0167b0De1E5");
