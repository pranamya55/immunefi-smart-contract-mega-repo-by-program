...
const Strategy = artifacts.require("PearlHodlStrategyMainnet_USDC_USDR");
...
describe("Mainnet Pearl USDC-USDR HODL in CVR", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x23BFc3D7E461Dc781A21903f4c49600F48CEaf6a";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xD17cb0f162f133e339C0BbFc18c36c357E681D6b");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(63732394366.2).times(D18);
