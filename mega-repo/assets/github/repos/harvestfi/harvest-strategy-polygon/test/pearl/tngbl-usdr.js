...
const Strategy = artifacts.require("PearlHodlStrategyMainnet_TNGBL_USDR");
...
describe("Mainnet Pearl TNGBL-USDR HODL in CVR", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x717CC576496acb1CC4c037174034eE895A9Eb829";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x0Edc235693C20943780b76D79DD763236E94C751");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(201996.395638).times(D18);
