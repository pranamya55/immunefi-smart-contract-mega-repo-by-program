...
const Strategy = artifacts.require("PearlHodlStrategyMainnet_PEARL_USDR");
...
describe("Mainnet Pearl PEARL-USDR HODL in CVR", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xf68c20d6C50706f6C6bd8eE184382518C93B368c");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(2101271.71428).times(D18);
