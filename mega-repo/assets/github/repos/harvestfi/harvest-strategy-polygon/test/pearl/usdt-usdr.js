...
const Strategy = artifacts.require("PearlHodlStrategyMainnet_USDT_USDR");
...
describe("Mainnet Pearl USDT-USDR HODL in CVR", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xA8aEd1e67E6935058985562AB7deF073d60699f4";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x3f69055F203861abFd5D986dC81a2eFa7c915b0c");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(63915094339.6).times(D18);
