...
const Strategy = artifacts.require("PearlHodlStrategyMainnet_DAI_USDR");
...
describe("Mainnet Pearl DAI-USDR HODL in CVR", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x5D1e5e5359984c793B5054F988288b8398377670";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xBD02973b441Aa83c8EecEA158b98B5984bb1036E");
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        lpPrice = new BigNumber(63713.4786661).times(D18);
