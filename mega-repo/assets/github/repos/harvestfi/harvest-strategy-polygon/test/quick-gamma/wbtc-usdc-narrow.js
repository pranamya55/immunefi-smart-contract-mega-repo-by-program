...
const Strategy = artifacts.require("QuickGammaStrategyV2Mainnet_WBTC_USDC_narrow");

//This test was developed at blockNumber 48397300

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Quickswap-Gamma WBTC-USDC (narrow)", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x079E810fB5B21BB8271B12Cd229b0cDA888Bd7Bf";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x3f35705479d9d77c619b2aAC9dd7a64e57151506");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        ...
        {"quickswap": [quick, usdc]},
        {"quickswap": [quick, weth, wbtc]},
      ],
    });
