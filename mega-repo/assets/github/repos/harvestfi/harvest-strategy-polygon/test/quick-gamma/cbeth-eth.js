...
const Strategy = artifacts.require("QuickGammaStrategyV2Mainnet_cbETH_ETH");

//This test was developed at blockNumber 48398290

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Quickswap-Gamma cbETH-ETH", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x0668331b4606bEb78A1c8314e08d8B07653fbD3C");
