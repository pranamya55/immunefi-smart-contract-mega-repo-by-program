...
const Strategy = artifacts.require("GammaMerklStrategyMainnet_QS_ETH_USDC");

//This test was developed at blockNumber 53865380

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Quickswap-Gamma ETH-USDC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x539460Bd8D7d6130ce6C4A65c0b59DA3b3d2da42";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x3974FbDC22741A1632E024192111107b202F214f");
