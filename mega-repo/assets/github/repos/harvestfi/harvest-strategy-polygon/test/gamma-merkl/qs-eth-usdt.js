...
const Strategy = artifacts.require("GammaMerklStrategyMainnet_QS_ETH_USDT");

//This test was developed at blockNumber 53865380

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Quickswap-Gamma ETH-USDT", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xC170AeDa8FCE5E9d87eddA09Bd64cF6967ae1Bd3";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x5928f9f61902b139e1c40cBa59077516734ff09f");
