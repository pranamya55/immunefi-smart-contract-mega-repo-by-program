...
const Strategy = artifacts.require("AaveSupplyStrategyMainnet_EURS");

//This test was developed at blockNumber 54064600

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Aave EURS", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x95E49B7a5a7aD75f0cd904f8f2329128025d9d2a";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xE111178A87A3BFf0c8d18DECBa5798827539Ae99");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"uniV3": [eurs, usdce, weth]},
        {"uniV3": [eurs, usdce, weth, addresses.miFARM]},
      ],
    });
