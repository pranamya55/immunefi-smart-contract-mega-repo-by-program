...
const Strategy = artifacts.require("StakeDAOLendStrategyMainnet_Llamalend_sfrxUSD");

//This test was developed at blockNumber 24598500

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet StakeDAO Lend sfrxUSD", function() {
  let accounts;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x2067525419e05E8FCA88992F326a42FCBFa8ddbc",
