...
const Strategy = artifacts.require("NotionalStrategyMainnet_nGHO");

//This test was developed at blockNumber 20514630

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Notional nGHO", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xf06fa5AACBDaeA548c75D8b0c146965E8BE9F1F2";
  let note = "0xCFEAead4947f0705A14ec42aC3D44129E1Ef3eD5";
  let weth = "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2";
  let gho = "0x40D16FC0246aD3160Ccc09B8D0D3A2cD28aE6C2f";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x2F7350Cb5e434C2d177922110c7e314953B84Afc");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "balPool": [
        [gho, usdc, "0x8353157092ed8be69a9df8f95af097bbf33cb2af0000000000000000000005d9"],
      ],
    });
