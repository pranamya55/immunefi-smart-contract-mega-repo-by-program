...
const Strategy = artifacts.require("PenpieStrategyMainnet_agETH2612");

//This test was developed at blockNumber 20585000

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Penpie agETH-LP 26/12", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x64331eb1337720D6b00d8943E51DD1CB482aFae7";
  let pendle = "0x808507121B80c02388fAd14726482e061B8da827";
  let weth = "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2";
  let ageth = "0xe1B4d34E8754600962Cd944B535180Bd758E6c2e";
  let rseth = "0xA1290d69c65A6Fe4DF752f95823fae25cB99e5A7";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x6010676Bc2534652aD1Ef5Fa8073DcF9AD7EBFBe");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"uniV3": [pendle, weth]},
        {"balancer": [weth, rseth, ageth]},
      ],
      "uniV3Fee": [
        [pendle, weth, 3000],
      ],
      "balPool": [
        [weth, rseth, "0x58aadfb1afac0ad7fca1148f3cde6aedf5236b6d00000000000000000000067f"],
        [rseth, ageth, "0xf1bbc5d95cd5ae25af9916b8a193748572050eb00000000000000000000006bc"],
      ],
    });
