...
const Strategy = artifacts.require("EulerLendStrategyMainnet_SM_USDC");

// Developed and tested at blockNumber 22480825

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Euler Lend Stablecoin Maxi USDC", function() {
  let accounts;
  ...
  describe("Happy path", function() {
    it("Farmer should earn money", async function() {
      ...
      await depositVault(farmer1, underlying, vault, farmerOldBalance.div(100));
