...
const Strategy = artifacts.require("ConvexStrategyMainnet_thUSD_3CRV");

//This test was developed at blockNumber 20505975

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Convex thUSD-3CRV", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x593c427d8C7bf5C555Ed41cd7CB7cCe8C9F15bB5";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x91553BAD9Fbc8bD69Ff5d5678Cbf7D514d00De0b");
