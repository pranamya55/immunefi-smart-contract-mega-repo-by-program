...
const Strategy = artifacts.require("ConvexStrategyMainnet_OETH");
const IBooster = artifacts.require("IBooster");

//This test was developed at blockNumber 19485855
...
describe("Mainnet Convex OETH", function() {
  ...
  // external setup
  let underlyingWhale = "0x69e078EBc4631E1947F0c38Ef0357De7ED064644";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x94B17476A93b3262d87B9a326965D1E91f9c13E7");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x924e022Ef8636FfA5971215e6Aac2652f7e9606e",
    ...
    await booster.earmarkRewards('174');
  });
