...
const Strategy = artifacts.require("ConvexStrategyMainnet_reUSD_sfrxUSD");

//This test was developed at blockNumber 22288200

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Convex reUSD-sfrxUSD", function () {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x411f9D604766f55cBEa7ca57c2d84d27D8193682";
  ...
  let sfrxusd = "0xcf62F905562626CfcDD2261162a51fd02Fc9c5b6";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xed785Af60bEd688baa8990cD5c4166221599A441");
  ...
  before(async function () {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      liquidation: [
        { uniV3: [cvx, weth] },
        { uniV3: [crv, weth] },
        { curve: [weth, crvusd, susde, sfrxusd] },
      ],
      uniV3Fee: [
        [weth, crv, "3000"],
        [weth, cvx, "10000"],
      ...
      curveSetup: [
        ...
        [
          susde,
          sfrxusd,
          "0x3bd1017929b43c1414be2aca39892590fba4d6e2",
          [1, 0, 1, 10, 2],
        ],
      ],
