...
describe("Mainnet Convex reUSD-scrvUSD", function () {
  ...
  // external setup
  let underlyingWhale = "0x46633b491C0DD7b245f47dA22855F33FA20a4E06";
  ...
  let scrvusd = "0x0655977FEb2f289A4aB78af67BAB0d17aAb84367";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xc522A6606BBA746d7960404F22a3DB936B6F4F50");
  ...
  before(async function () {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      liquidation: [
        { uniV3: [cvx, weth] },
        { uniV3: [crv, weth] },
        { curve: [weth, crvusd, susde, scrvusd] },
      ],
      uniV3Fee: [
        [weth, crv, "3000"],
        [weth, cvx, "10000"],
