...
const Strategy = artifacts.require("IdleStrategyMainnet_USDT");

//This test was developed at blockNumber 19534600
...
describe("Mainnet Idle USDT", function() {
  ...
  // external setup
  let underlyingWhale = "0x706481b340dAA42b64dc67C61682a92a8dfABbd7";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"uniV3": [idle, weth]},
        {"uniV3": [idle, weth, usdt]},
        {"uniV3": [usdt, weth, idle]},
      ],
      "uniV3Fee": [
        [weth, idle, '3000'],
      ]
