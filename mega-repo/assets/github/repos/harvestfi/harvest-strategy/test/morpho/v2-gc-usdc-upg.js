...
const Strategy = artifacts.require("MorphoVaultStrategyV2Mainnet_GC_USDC");

// Developed and tested at blockNumber 23246180

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Morpho Gauntlet Core USDC - upgrade", function() {
  let accounts;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x47B8cdAe3BcEb0DA3236ACF2B288A01A81672AcC",
