...
const Strategy = artifacts.require("MorphoVaultStrategyV2Mainnet_MEV_USDC");

// Developed and tested at blockNumber 23246180

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Morpho MEV USDC - upgrade", function() {
  let accounts;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0xb8251D5031b64DeCE863eA72a715F7b410659d87",
