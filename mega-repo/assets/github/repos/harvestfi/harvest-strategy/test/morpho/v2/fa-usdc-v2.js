...
const Strategy = artifacts.require("MorphoVaultStrategyMainnet_FA_USDC_V2");

// Developed and tested at blockNumber 24369700

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Morpho Vault V2 Alpha USDC Core", function() {
  let accounts;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x6D84799f874918A7762625805d68Cf3181d8d5f2",
