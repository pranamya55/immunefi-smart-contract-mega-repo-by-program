...
const FixStrategy = artifacts.require("ZerolendFoldStrategyFIXMainnet_WBTC");

// Developed and tested at blockNumber 22480825

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Morpho RE7 WBTC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x85bd033A8709b4D6603c2A1a8eef1Fd147F0Ca32";
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "fixStrategyArtifact": FixStrategy,
      "fixStrategy": true,
