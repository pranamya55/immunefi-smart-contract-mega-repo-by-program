...
const Strategy = artifacts.require("MorphoVaultStrategyV2Mainnet_HY_USDC");

// Developed and tested at blockNumber 23246180

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Morpho Hyperithm USDC - upgrade", function() {
  let accounts;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0xD02daFa6E9145ce1FAA786F80A50202E8a4255f8",
