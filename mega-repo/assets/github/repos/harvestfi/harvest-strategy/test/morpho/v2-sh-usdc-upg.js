...
const Strategy = artifacts.require("MorphoVaultStrategyV2Mainnet_SH_USDC");

// Developed and tested at blockNumber 23246180

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet Morpho Stakehouse USDC - upgrade", function() {
  let accounts;
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      "existingVaultAddress": "0x67735DC14F14deb8d1acdFf09a41e6bDA7234EBB",
