...
const Strategy = artifacts.require("ZerolendFoldStrategyMainnet_MBTC");

//This test was developed at blockNumber 21221280

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet ZeroLend M-BTC", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x533806B821eC94091228d7D34e697B93Bb79f8F6";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0x2F913C820ed3bEb3a67391a6eFF64E70c4B20b19");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"uniV3": [zero, weth, wbtc, underlying.address]},
        {"uniV3": [zero, weth]},
        {"uniV3": [underlying.address, wbtc, weth]},
      ],
      "uniV3Fee": [
        [zero, weth, '10000'],
        [underlying.address, wbtc, '500'],
      ],
    });
