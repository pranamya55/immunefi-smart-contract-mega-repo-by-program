...
const Strategy = artifacts.require("ZerolendFoldStrategyMainnet_weETH");

//This test was developed at blockNumber 21222100

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet ZeroLend weETH", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0x3f37bC2DBb082128273E6bb533F80Cd63e7A4200";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xCd5fE23C85820F7B72D0926FC9b05b43E359b7ee");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"uniV3": [zero, weth, underlying.address]},
        {"uniV3": [zero, weth]},
        {"uniV3": [underlying.address, weth]},
      ],
      "uniV3Fee": [
        [zero, weth, '10000'],
        [underlying.address, weth, '100'],
      ],
    });
