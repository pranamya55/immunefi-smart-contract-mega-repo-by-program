...
const Strategy = artifacts.require("ZerolendFoldStrategyMainnet_SolvBTCBNN");

//This test was developed at blockNumber 21221280

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Mainnet ZeroLend SolvBTC.BNN", function() {
  let accounts;
  ...
  // external setup
  let underlyingWhale = "0xA2Df5770b8cB729529b45E50343DAaBC20d31C43";
  let zero = "0x2Da17fAf782ae884faf7dB2208BBC66b6E085C22";
  let weth = "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2";
  let wbtc = "0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599";
  let solvbtc = "0x7A56E1C57C7475CCf742a1832B028F0456652F97";
  ...
  async function setupExternalContracts() {
    underlying = await IERC20.at("0xd9D920AA40f578ab794426F5C90F6C731D159DEf");
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidation": [
        {"uniV3": [zero, weth]},
        {"curve": [underlying.address, solvbtc, wbtc, weth]},
        {"curve": [weth, wbtc, solvbtc, underlying.address]},
      ],
      "uniV3Fee": [
        [zero, weth, '10000'],
      ],
      ...
      "curveSetup": [
        [underlying.address, solvbtc, "0x8ea96fc70c577d59528c98C31bc4BF39027c1C3e", [0, 1, 1, 10, 2]],
        [solvbtc, underlying.address, "0x8ea96fc70c577d59528c98C31bc4BF39027c1C3e", [1, 0, 1, 10, 2]],
        [wbtc, solvbtc, "0xF1005aC82E89dE676449525c3Cb86959216864C1", [1, 0, 1, 10, 2]],
        [solvbtc, wbtc, "0xF1005aC82E89dE676449525c3Cb86959216864C1", [0, 1, 1, 10, 2]],
