...
import {IAccountingOracle} from "./IAccountingOracle.sol";
import {IOracleReportSanityChecker} from "./IOracleReportSanityChecker.sol";

interface ILidoLocator {
    function accountingOracle() external view returns (IAccountingOracle);
    function depositSecurityModule() external view returns (address);
    function elRewardsVault() external view returns (address);
    function lido() external view returns (address);
    function oracleReportSanityChecker() external view returns (IOracleReportSanityChecker);
