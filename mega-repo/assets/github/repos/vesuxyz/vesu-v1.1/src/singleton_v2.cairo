...
mod SingletonV2 {
    ...
    impl InternalFunctions of InternalFunctionsTrait {
        ...
        fn _migrate_position(
            ...
            let (position_v1, _, _) = ISingletonV2Dispatcher { contract_address: self.singleton_v1.read() }
                .position(pool_id, collateral_asset, debt_asset, from);
            let position_v2 = self.positions.read((pool_id, collateral_asset, debt_asset, to));
            self
                .positions
                .write(
                    (pool_id, collateral_asset, debt_asset, to),
                    Position {
                        collateral_shares: position_v1.collateral_shares + position_v2.collateral_shares,
                        nominal_debt: position_v1.nominal_debt + position_v2.nominal_debt,
                    },
                );
            ...
            self
                .emit(
                    MigratePosition {
                        ...
                        from,
                        to,
                        collateral_shares: position_v1.collateral_shares,
                        nominal_debt: position_v1.nominal_debt,
                    },
                );
        }
