...
moc_staking = '0xF5ad1A6F6BA49C507Bb24676bbF80b8ed19B694c'
...
account_address = '0x67BcDfCDfc4F4ff2D6688a23717480548016E98D'
...
print("Allowance: {0} {1}".format(moc_token.allowance(account_address, moc_staking), moc_token.symbol()))

if amount_allow > 0:
    print("Allowing ... {0} MOC".format(amount_allow))
    moc_token.approve(moc_staking, amount_allow)
