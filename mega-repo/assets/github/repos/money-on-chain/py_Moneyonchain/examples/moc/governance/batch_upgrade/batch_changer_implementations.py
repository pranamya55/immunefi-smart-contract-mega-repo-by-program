...
# MOC
proxy_address = settings[config_network]['proxies']['MoC']
implementation_address = settings[config_network]['implementations']['MoC']
...
# MoCInrate
proxy_address = settings[config_network]['proxies']['MoCInrate']
implementation_address = settings[config_network]['implementations']['MoCInrate']

targets_to_execute.append(upgrade_delegator.address())
data_to_execute.append(upgrade_delegator.sc.upgrade.encode_input(proxy_address, implementation_address))

# MoCState
proxy_address = settings[config_network]['proxies']['MoCState']
implementation_address = settings[config_network]['implementations']['MoCState']
...
# MoCConverter
proxy_address = settings[config_network]['proxies']['MoCConverter']
implementation_address = settings[config_network]['implementations']['MoCConverter']

targets_to_execute.append(upgrade_delegator.address())
data_to_execute.append(upgrade_delegator.sc.upgrade.encode_input(proxy_address, implementation_address))

# MoCExchange
proxy_address = settings[config_network]['proxies']['MoCExchange']
implementation_address = settings[config_network]['implementations']['MoCExchange']
...
# # CommissionSplitter
# proxy_address = settings[config_network]['proxies']['CommissionSplitter']
# implementation_address = settings[config_network]['implementations']['CommissionSplitter']
#
# targets_to_execute.append(upgrade_delegator.address())
# data_to_execute.append(upgrade_delegator.sc.upgrade.encode_input(proxy_address, implementation_address))
