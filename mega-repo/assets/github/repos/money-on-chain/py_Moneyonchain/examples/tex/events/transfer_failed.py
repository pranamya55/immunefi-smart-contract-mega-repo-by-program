...
from moneyonchain.tex import MoCDecentralizedExchange, DEXTransferFailed
...
logging.basicConfig(level=logging.INFO,
                    ...
                    datefmt='%Y-%m-%d %H:%M:%S',
                    filename='logs/transfer_failed.log',
                    filemode='a')
...
if l_events:
    ...
    path_file = '{0}_transfer_failed_{1}_{2}.csv'.format(config_network, from_block, to_block)
