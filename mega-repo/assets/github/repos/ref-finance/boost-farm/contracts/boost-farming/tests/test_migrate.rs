...
fn test_update(){
    ...
    assert_eq!(e.get_metadata020().version, "0.4.2".to_string());
    ...
    affected_seeds.insert(seed_id.clone(), U128(10 * 10u128.pow(18)));
    let booster_info = BoosterInfo { booster_decimal: 18, affected_seeds, boost_suppress_factor: 1 };
