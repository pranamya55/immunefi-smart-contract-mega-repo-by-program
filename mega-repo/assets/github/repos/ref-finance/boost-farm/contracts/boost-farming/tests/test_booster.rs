...
fn test_modify_booster(){
    ...
    affected_seeds.insert(seed_id.clone(), U128(100));
    ...
    affected_seeds_include_own.insert(seed_id.clone(), U128(100));
    affected_seeds_include_own.insert(booster_id.clone(), U128(100));
    ...
    affected_seeds_not_exist.insert("seed".to_string(), U128(100));
    ...
    for i in 0..MAX_NUM_SEEDS_PER_BOOSTER + 1 {
        ...
        affected_seeds_exceed_seed.insert(temp_seed_id, U128(100));
    }
    ...
    for i in 0..MAX_NUM_SEEDS_PER_BOOSTER {
        ...
        for _ in 0..e.get_config().max_num_farms_per_booster / MAX_NUM_SEEDS_PER_BOOSTER as u32 + 1 {
            e.create_farm(&e.owner, &temp_seed_id, &tokens.nref, to_sec(e.current_time()), to_yocto("10")).assert_success();
            affected_seeds_exceed_farm.insert(temp_seed_id.clone(), U128(100));
        }
    }
    ...
    let mut affected_seeds = HashMap::new();
    affected_seeds.insert(seed_id.clone(), U128(100));
    affected_seeds.insert(tokens.love_ref.account_id.to_string().clone(), U128(100));
    let booster_info = BoosterInfo { booster_decimal: 18, affected_seeds: affected_seeds.clone(), boost_suppress_factor: 1};
    ...
    let mut affected_seeds = HashMap::new();
    affected_seeds.insert(format!("{}{}", seed_id, 0).clone(), U128(100));
    let booster_info = BoosterInfo { booster_decimal: 18, affected_seeds: affected_seeds.clone(), boost_suppress_factor: 1};
