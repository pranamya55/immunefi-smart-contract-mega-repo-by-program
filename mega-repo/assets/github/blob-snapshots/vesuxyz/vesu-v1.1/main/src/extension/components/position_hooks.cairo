...
pub struct ShutdownStatus {
    ...
    pub violating: bool,
    pub previous_violation_timestamp: u64,
    pub count_at_violation_timestamp: u128,
}
...
pub mod position_hooks_component {
    ...
    use vesu::units::{MIN_LIQUIDATION_AMOUNT, SCALE};
    ...
    > of Trait<TContractState> {
        ...
        fn shutdown_status(self: @ComponentState<TContractState>, ref context: Context) -> ShutdownStatus {
            ...
            ShutdownStatus {
                shutdown_mode, violating, previous_violation_timestamp: 0, count_at_violation_timestamp: 0,
            }
        }
        ...
        fn update_shutdown_status(ref self: ComponentState<TContractState>, ref context: Context) -> ShutdownMode {
            ...
            // if there is a current violation and no timestamp exists for the pair, then set it (recovery)
            if violating {
                self
                    .fixed_shutdown_mode
